...
use crate::utils::write_content_inside_text_block;
use std::io;

pub fn write(theme: &mut Theme) -> io::Result<()> {
...
"###,
    ...
    local syn = {{
        ...
        func        = P.blue.{i},
        ident       = P.cyan.base,
        keyword     = P.magenta.base,
        number      = P.orange.base,
        operator    = P.fg2,
        preproc     = P.pink.{i},
        regex       = P.yellow.{i},
        statement   = P.magenta.base,
        string      = P.green.base,
        type        = P.yellow.base,
        variable    = P.fg1,
    }}
...
"###,
    ...
    for group, opts in pairs({
        ...
        WinSeparator = { fg = P.bg0 },
        VertSplit    = { link = "WinSeparator" },
        Folded       = { fg = P.fg3, bg = P.bg2 },
        FoldColumn   = { fg = P.fg3 },
        SignColumn   = { fg = P.fg3 },
        SignColumnSB = { link = "SignColumn" },
        Substitute   = { fg = P.bg1, bg = spec.diag.error },
        LineNr       = { fg = P.fg3 },
        ...
        NonText      = { fg = P.bg4 },
        Normal       = { fg = P.fg1, bg = trans and "NONE" or P.bg1 },
        NormalNC     = { fg = P.fg1, bg = (inactive and P.bg0) or (trans and "NONE") or P.bg1 },
        NormalFloat  = { fg = P.fg1, bg = P.bg0 },
        FloatBorder  = { fg = P.fg3 },
        Pmenu        = { fg = P.fg1, bg = P.sel0 },
        PmenuSel     = { bg = P.sel1 },
        PmenuSbar    = { link = "Pmenu" },
        PmenuThumb   = { bg = P.sel1 },
        Question     = { link = "MoreMsg" },
        QuickFixLine = { link = "CursorLine" },
        Search       = inv.search and { style = "reverse" } or { fg = P.fg1, bg = P.sel1 },
        IncSearch    = inv.search and { style = "reverse" } or { fg = P.bg1, bg = spec.diag.hint },
        ...
        StatusLine   = { fg = P.fg2, bg = P.status_line },
        StatusLineNC = { fg = P.fg3, bg = P.status_line },
        TabLine      = { fg = P.fg2, bg = P.bg2 },
        TabLineFill  = { bg = P.bg0 },
        TabLineSel   = { fg = P.bg1, bg = P.fg3 },
        Title        = { fg = syn.func, style = "bold" },
        Visual       = inv.visual and { style = "reverse" } or { bg = P.sel0 },
        VisualNOS    = inv.visual and { style = "reverse" } or { link = "visual" },
        WarningMsg   = { fg = spec.diag.warn },
        Whitespace   = { fg = P.bg3 },
        WildMenu     = { link = "Pmenu" },
        WinBar       = { fg = P.fg3, bg = trans and "NONE" or P.bg1, style = "bold" },
        WinBarNC     = { fg = P.fg3, bg = trans and "NONE" or inactive and P.bg0 or P.bg1, style = "bold" },
        ...
        Todo           = { fg = P.bg1, bg = spec.diag.info },
        ...
        ["@comment.error"] = { fg = P.bg1, bg = spec.diag.error },
        ["@comment.warning"] = { fg = P.bg1, bg = spec.diag.warn },
        ["@comment.todo"] = { fg = P.bg1, bg = spec.diag.hint },
        ["@comment.note"] = { fg = P.bg1, bg = spec.diag.info },
        ["@markup"] = { fg = P.fg1 },
        ["@markup.strong"] = { fg = P.red.base, style = "bold" },
        ["@markup.italic"] = { link = "Italic" },
        ["@markup.strikethrough"] = { fg = P.fg1, style = "strikethrough" },
        ["@markup.underline"] = { link = "Underline" },
        ["@markup.heading"] = { link = "Title" },
        ["@markup.quote"] = { fg = P.fg2 },
        ...
        ["@markup.raw.block"] = { fg = P.pink.base },
        ["@markup.list"] = { fg = syn.builtin1, style = stl.operators },
        ["@markup.list.checked"] = { fg = P.green.base },
        ["@markup.list.unchecked"] = { fg = P.yellow.base },
...
"###;
    ...
    let content = format!("{HEAD}{palette}{spec}{TAIL}")
    Ok(())
}
